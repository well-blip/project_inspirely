...
import "./AssignmentNotificationCard.css";
...
const AssignmentNotificationCard: React.FC<AssignmentNotificationCardProps> = ({
  assignment,
}) => {
...
export default <ScheduledMeetingContent></ScheduledMeetingContent>;

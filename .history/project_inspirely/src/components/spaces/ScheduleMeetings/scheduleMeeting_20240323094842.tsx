...
import UpdateMeetingContent from './updateMeeting'; // Updated component name
...
const ScheduleMeeting = () => {
  ...
  const handleButtonClick = (action: string) => {
    if (action === "Update Meeting Details") {
      // Handle the action for updating meeting details
      // For example, you can set a state to show the update meeting section
      setShowScheduleMeeting(false); // Hide the schedule meeting section
      // You can add additional logic here to handle updating meeting details
    }
  };
